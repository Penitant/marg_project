...
function getCssColorMap() {
  ...
  return {
    ...
    congestionLow: styles.getPropertyValue('--viz-congestion-low').trim(),
    congestionHigh: styles.getPropertyValue('--viz-congestion-high').trim(),
    signalNS: styles.getPropertyValue('--viz-node-ns').trim(),
    signalEW: styles.getPropertyValue('--viz-node-ew').trim(),
    signalYellow: styles.getPropertyValue('--viz-node-yellow').trim(),
    signalCore: styles.getPropertyValue('--viz-node-core').trim(),
    signalOutline: styles.getPropertyValue('--viz-node-outline').trim(),
    corridor: styles.getPropertyValue('--corridor-500').trim(),
    ambulanceFill: styles.getPropertyValue('--viz-ambulance-fill').trim(),
    ambulanceBorder: styles.getPropertyValue('--viz-ambulance-border').trim(),
    ambulanceGlow: styles.getPropertyValue('--viz-ambulance-glow').trim(),
    destinationRing: styles.getPropertyValue('--viz-destination-ring').trim(),
    destinationCore: styles.getPropertyValue('--viz-destination-core').trim(),
  }
}
